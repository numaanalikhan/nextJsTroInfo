...
> first we destructure {email and password} from request.json(),we call the user
...
- at last we do post request
  _ first configureing the axios instance and exporting as axiosInstance
  _ secon in helper folder we call the
  axiosInstance.post("api/login"/,state)
  .then((res)=>{res}) \* in ui page we just call the fun and pass the state variables
  ......................................................................................
...
## What are non-protected routes

/singup and /login

## what are protected routes

/add-task, /show-tasks , /api/:paths* , / , /profile/:path*

## difficulties faced while implementing middleware

why we returned if request.nextUrl.pathname === /api/login ,
